...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app_bundle.service.listener' => 'getAppBundle_Service_ListenerService',
    ...
    /**
     * Gets the 'anca_rebeca_full_calendar.service.calendar' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AncaRebeca\FullCalendarBundle\Service\Calendar A AncaRebeca\FullCalendarBundle\Service\Calendar instance
     */
    protected function getAncaRebecaFullCalendar_Service_CalendarService()
    {
        return $this->services['anca_rebeca_full_calendar.service.calendar'] = new \AncaRebeca\FullCalendarBundle\Service\Calendar(new \AncaRebeca\FullCalendarBundle\Service\Serializer(), $this->get('debug.event_dispatcher'));
    }
    ...
    /**
     * Gets the 'app_bundle.service.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Listener\LoadDataListener A AppBundle\Listener\LoadDataListener instance
     */
    protected function getAppBundle_Service_ListenerService()
    {
        return $this->services['app_bundle.service.listener'] = new \AppBundle\Listener\LoadDataListener();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5rGfV0jppo', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sYCc+WhxVm', 0, 'Y7huOaJsR2k5T3OB2WImWA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-ofA4nlcq9', 0, 'Y7huOaJsR2k5T3OB2WImWA', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BzjR5RAP17', 0, 'Y7huOaJsR2k5T3OB2WImWA', (__DIR__.'/pools'), $a));
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('fullcalendar.set_data', array(0 => 'app_bundle.service.listener', 1 => 'loadData'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'InSocietyBDDS', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array('charset' => 'latin1_swedish_ci', 'collate' => 'latin1_swedish_ci')), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_999c9dab1f87e7f3eac892b481635dc951bb178fe21de721abc78d7afd707d52');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('62241c95480ca1a62572d5a4baac3038cec30308');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5ae9c6671304c0.89794664')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '62241c95480ca1a62572d5a4baac3038cec30308',
            'locale' => 'en',
            'brochures_directory' => ($this->targetDirs[3].'\\app/../web/uploads/documents'),
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '62241c95480ca1a62572d5a4baac3038cec30308',
