 ...
 */
class Statut extends \AppBundle\Entity\Statut implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Statut' . "\0" . 'libeller', '' . "\0" . 'AppBundle\\Entity\\Statut' . "\0" . 'idStatut'];
        }
